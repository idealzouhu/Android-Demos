...
- [启动问题.md](docs/启动问题.md): 说明冷启动阶段的常见性能问题与排查思路。
...
- [startup-slow-launch-java-view](startup-slow-launch-java-view/README.md): 列举在 `Application.onCreate()` 中执行重活导致冷启动变慢的常见错误案例。
